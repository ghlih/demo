    ...
    $(function () {
       ...
       */
        $("#rolePageBody").on("click", ".pencilBtn", function () {
            ...
            //获取当前角色的id
            //依据是：var pencilBtn = "<button id='"+roleId+"'……这段代码中我们把roleId
            //设置到id属性了
        ...
        $("#rolePageBody").on("click", ".itemBox", function () {
            //获取当前选中的.itemBox的数量
            var checkedBoxLength = $(".itemBox:checked").length;
            //获取全部.itemBox的数量
            var totalBoxCount = $(".itemBox").length;
            //使用二者的比较结果设置总的checkbox
            $("#summaryBox").prop("checked", checkedBoxLength == totalBoxCount);
        });

        //12.给批量删除的按钮绑定单击响应函数
        $("#batchRemoveBtn").click(function () {
            //创建一个对象数组用来存放后面取到的角色对象
            var roleArray = [];
            //遍历当前选中的多选框
                        ...
                        <div class="form-group has-feedback">
                            <div class="input-group">
                                ...
                                <input id="keywordInput" class="form-control has-success" type="text"
                                       placeholder="请输入查询条件" value="${requestScope.keyword}">
                            </div>
                        </div>
